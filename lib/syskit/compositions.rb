module Orocos
    module RobyPlugin
        ...
        module CompositionModel
            ...
            attribute(:explicit_connections) { Hash.new { |h, k| h[k] = Array.new } }
            # The set of connections automatically generated by
            # compute_autoconnection
            attribute(:automatic_connections) { Hash.new { |h, k| h[k] = Array.new } }
            ...
            def instanciate(engine, arguments = Hash.new)
                ...
                connections.each do |(out_name, in_name), mappings|
                    children_tasks[out_name].add_sink(children_tasks[in_name], mappings)
                end
                self_task
            end
        end
