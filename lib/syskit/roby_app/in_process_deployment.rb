...
module Syskit
    module RobyApp
        ...
        # have been instanciated in-process
        class InProcessDeployment < Orocos::ProcessBase
            extend Logger::Hierarchy
            include Logger::Hierarchy

            # The {InProcessTasksManager} object which created this
            #
            ...
            #
            # This is always Process.pid as in-process tasks are instanciated inside the
            # ruby process
            #
            # @return [Integer]
            attr_reader :pid
            ...
            # @return [void]
            def spawn(_options = {})
                @deployed_tasks = model.each_task.each_with_object({}) do |deployed, h|
                    mapped_name = get_mapped_name(deployed.name)
