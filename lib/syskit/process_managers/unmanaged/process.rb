...
module Syskit
    module ProcessManagers
        module Unmanaged
            # Representation of a deployment that is started externally
            #
            # A {Unmanaged::Process} can basically be in three states, which are
            ...
            class Process < ProcessBase
                ...
                # The {Manager} object which created this
                #
                ...
                # Returns the deployed tasks.
                #
                # The deployed tasks are resolved on wait_running, which is called by
                # `update_deployment_states.rb` when making the deployment ready.
                #
                ...
                #
                # @param [Hash<String, Orocos::TaskContext>] tasks
